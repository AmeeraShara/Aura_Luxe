    ...
    @else
        <div class="cart-grid">
                ...
                <div class="cart-item">
                    ...
                    <div class="cart-details">
                        ...
                        <div class="cart-actions">
                            ...
                            <p class="cart-price">LKR {{ number_format($item->product_price * $item->quantity, 2) }}</p>
            ...
            <div class="order-summary">
                ...
                <p><span>Shipping:</span> <strong>{{ $shipping == 0 ? 'Free' : 'LKR ' . number_format($shipping, 2) }}</strong></p>
